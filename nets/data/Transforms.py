# -*- coding: utf-8 -*-
# @Author  : LG
from nets.struct.Utils.Boxs_op import center_form_to_corner_form, assign_priors,\
...
class targettransform:
    ...
    def __init__(self, cfg):
        from nets.struct import priorbox  # 避免循环导入.(模型中detect方法会使用transform,而targettransform会使用到priorbox, 这样写可以避免循环导入)
