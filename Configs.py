...
_C.MODEL.TEST.NMS_THRESHOLD = 0.3              # 非极大抑制阈值
...
_C.DATA.DATASET.DATA_DIR = r'D:\1Acyn\FUDAN\2022学年\计算机视觉\pj2-目标检测算法\faster-rcnn-pytorch\VOCdevkit\VOC2012'   # 数据集voc格式,根目录   请更改为自己的目录
